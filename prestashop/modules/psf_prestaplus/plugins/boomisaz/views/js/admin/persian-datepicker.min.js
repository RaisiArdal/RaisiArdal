...
$(document).ready(function() {
    ...
    var datePickerClickable = $(".datepicker input");

    datePickerClickable.click(function(){
        date = null;
    	datePickerInput = $(this).prev();
    });

	datePickerClickable.pDatepicker({
		format : 'YYYY-MM-DD',
		altField : $(this),
        ...
        onSelect: function(unix){
            date = new persianDate(unix).format('YYYY-MM-DD');
            datePickerInput.attr('restore', date);
			datePickerInput.val(date);
		},
        onShow: function(){
            if ( datePickerInput.attr('restore') != null ) {
                datePickerInput.val(datePickerInput.attr('restore'));
            } else if ( date != null) {
                datePickerInput.val(date);
            } else {
                datePickerInput.val(new persianDate(new Date()).format('YYYY-MM-DD'));
            }
        }
	});
    ...
    $(document).ajaxSend(function(){
        if( $("#edit-specific-price-modal-form").length > 0 ) {
            $('#form_modal_save').mousedown(function(e){
                var input = $('#edit-specific-price-modal-form input');
                input.each(function(){
